...
public class InGameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log(levelData.DynamicEnemies[0]);

        //dynamicEnemy.Initialize(levelData.DynamicEnemies[0]);
        Vector3 spawnPos = new Vector3(player.transform.position.x, player.transform.position.y + 25, player.transform.position.z);
        Instantiate(levelData.DynamicEnemies[0], spawnPos, transform.rotation);
